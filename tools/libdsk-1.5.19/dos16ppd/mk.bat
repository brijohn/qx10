...
%CC% %CFLAGS% -c ../lib/ldbs2txt.c
if errorlevel 1 goto abort
%CC% %CFLAGS% -c ../lib/txt2ldbs.c
if errorlevel 1 goto abort
...
if errorlevel 1 goto abort
%CC% %CFLAGS% -c ../lib/drvldbst.c
if errorlevel 1 goto abort
%CC% %CFLAGS% -c ../lib/drvlogi.c
if errorlevel 1 goto abort
rem This crashes the compiler too!
rem %CC% %CFLAGS% -c ../lib/drvmyz80.c
rem if errorlevel 1 goto abort
...
if errorlevel 1 goto abort
libr r libdsk.lib drvldbst.obj
if errorlevel 1 goto abort
...
if errorlevel 1 goto abort
libr r libdsk.lib ldbs2txt.obj
if errorlevel 1 goto abort
libr r libdsk.lib txt2ldbs.obj
if errorlevel 1 goto abort
rem
...
if errorlevel 1 goto abort
%CC% %CFLAGS% ../tools/dskparse.c utilopts.obj libdsk.lib
if errorlevel 1 goto abort
