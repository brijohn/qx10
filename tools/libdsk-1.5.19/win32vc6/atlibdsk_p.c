...
#define PROC_FORMAT_STRING_SIZE   2971                              
...
/* Object interface: ILibrary2, ver. 0.0,
   GUID={0x0FA336CF,0x2B28,0x4354,{0x9B,0xA7,0x49,0xB7,0xD3,0x53,0xEF,0x37}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ILibrary2_ServerInfo;
...
static const unsigned short ILibrary2_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO ILibrary2_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &ILibrary2_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO ILibrary2_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &ILibrary2_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(21) _ILibrary2ProxyVtbl = 
{
    &ILibrary2_ProxyInfo,
    &IID_ILibrary2,
    IUnknown_QueryInterface_Proxy,
    ...
    (void *)-1 /* ILibrary::get_reporter */ ,
    (void *)-1 /* ILibrary::put_reporter */ ,
    (void *)-1 /* ILibrary2::diag_open */
};


static const PRPC_STUB_FUNCTION ILibrary2_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _ILibrary2StubVtbl =
{
    &IID_ILibrary2,
    &ILibrary2_ServerInfo,
    21,
    &ILibrary2_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
/* 2932 */	0x7,		/* Oi2 Flags:  srv must size, clt must size, has return, */
			0x6,		/* 6 */
...
/* 2936 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 2938 */	NdrFcShort( 0x418 ),	/* Type Offset=1048 */
...
/* 2942 */	NdrFcShort( 0x8 ),	/* x86, MIPS, PPC Stack size/offset = 8 */
			...
			NdrFcShort( 0x10 ),	/* Alpha Stack size/offset = 16 */
#endif
/* 2944 */	NdrFcShort( 0x17a ),	/* Type Offset=378 */

	/* Parameter driver */

/* 2946 */	NdrFcShort( 0x8b ),	/* Flags:  must size, must free, in, by val, */
#ifndef _ALPHA_
/* 2948 */	NdrFcShort( 0xc ),	/* x86, MIPS, PPC Stack size/offset = 12 */
#else
			NdrFcShort( 0x18 ),	/* Alpha Stack size/offset = 24 */
#endif
/* 2950 */	NdrFcShort( 0x418 ),	/* Type Offset=1048 */

	/* Parameter compress */

/* 2952 */	NdrFcShort( 0x8b ),	/* Flags:  must size, must free, in, by val, */
#ifndef _ALPHA_
/* 2954 */	NdrFcShort( 0x10 ),	/* x86, MIPS, PPC Stack size/offset = 16 */
#else
			NdrFcShort( 0x20 ),	/* Alpha Stack size/offset = 32 */
#endif
/* 2956 */	NdrFcShort( 0x418 ),	/* Type Offset=1048 */

	/* Parameter ppDisk */

/* 2958 */	NdrFcShort( 0x13 ),	/* Flags:  must size, must free, out, */
#ifndef _ALPHA_
/* 2960 */	NdrFcShort( 0x14 ),	/* x86, MIPS, PPC Stack size/offset = 20 */
#else
			NdrFcShort( 0x28 ),	/* Alpha Stack size/offset = 40 */
#endif
/* 2962 */	NdrFcShort( 0x422 ),	/* Type Offset=1058 */

	/* Return value */

/* 2964 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
#ifndef _ALPHA_
/* 2966 */	NdrFcShort( 0x18 ),	/* x86, MIPS, PPC Stack size/offset = 24 */
#else
			NdrFcShort( 0x30 ),	/* Alpha Stack size/offset = 48 */
#endif
/* 2968 */	0x8,		/* FC_LONG */
...
const CInterfaceProxyVtbl * _atlibdsk_ProxyVtblList[] = 
{
    ...
    ( CInterfaceProxyVtbl *) &_ILibrary2ProxyVtbl,
...
int __stdcall _atlibdsk_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _atlibdsk, 5, 4 )
    IID_BS_LOOKUP_NEXT_TEST( _atlibdsk, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _atlibdsk, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _atlibdsk, 5, *pIndex )
