...
class ATL_NO_VTABLE CLibrary : 
	...
	public IDispatchImpl<ILibrary2, &IID_ILibrary2, &LIBID_LIBDSK>
{
public:
	CLibrary()
	{
...
//	STDMETHOD(set_reporter)(/*[in]*/ IReporter *pv);
	...
	STDMETHOD(diag_open)(/*[in,string]*/ BSTR filename, /*[in]*/ IDispatch *reporter, /*[in, string]*/ BSTR driver, /*[in,string]*/ BSTR compress, 
		/*[out, result]*/ IDisk **ppDisk);
