...
#ifndef __ILibrary2_FWD_DEFINED__
#define __ILibrary2_FWD_DEFINED__
typedef interface ILibrary2 ILibrary2;
#endif 	/* __ILibrary2_FWD_DEFINED__ */
...
#ifndef __ILibrary2_INTERFACE_DEFINED__
#define __ILibrary2_INTERFACE_DEFINED__

/* interface ILibrary2 */
/* [unique][helpstring][dual][uuid][object] */ 


EXTERN_C const IID IID_ILibrary2;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("0FA336CF-2B28-4354-9BA7-49B7D353EF37")
    ILibrary2 : public ILibrary
    {
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE diag_open( 
            /* [in] */ BSTR filename,
            /* [in] */ IDispatch __RPC_FAR *reporter,
            /* [optional][in] */ BSTR driver,
            /* [optional][in] */ BSTR compress,
            /* [retval][out] */ IDisk __RPC_FAR *__RPC_FAR *ppDisk) = 0;
    ...
    typedef struct ILibrary2Vtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            ILibrary2 __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *diag_open )( 
            ILibrary2 __RPC_FAR * This,
            /* [in] */ BSTR filename,
            /* [in] */ IDispatch __RPC_FAR *reporter,
            /* [optional][in] */ BSTR driver,
    ...
    interface ILibrary2
    {
        CONST_VTBL struct ILibrary2Vtbl __RPC_FAR *lpVtbl;
    };
...
#define ILibrary2_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define ILibrary2_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define ILibrary2_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define ILibrary2_GetTypeInfoCount(This,pctinfo)	\
    (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo)

#define ILibrary2_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo)

#define ILibrary2_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)

#define ILibrary2_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)


#define ILibrary2_open(This,filename,driver,compress,ppDisk)	\
    (This)->lpVtbl -> open(This,filename,driver,compress,ppDisk)

#define ILibrary2_create(This,filename,driver,compress,ppDisk)	\
    (This)->lpVtbl -> create(This,filename,driver,compress,ppDisk)

#define ILibrary2_stdformat(This,formatid,name,description,geom)	\
    (This)->lpVtbl -> stdformat(This,formatid,name,description,geom)

#define ILibrary2_get_psh(This,sectorsize,shift)	\
    (This)->lpVtbl -> get_psh(This,sectorsize,shift)

#define ILibrary2_get_stdformat_count(This,pVal)	\
    (This)->lpVtbl -> get_stdformat_count(This,pVal)

#define ILibrary2_dosgeom(This,buffer,geom)	\
    (This)->lpVtbl -> dosgeom(This,buffer,geom)

#define ILibrary2_cpm86geom(This,buffer,geom)	\
    (This)->lpVtbl -> cpm86geom(This,buffer,geom)

#define ILibrary2_pcwgeom(This,buffer,geom)	\
    (This)->lpVtbl -> pcwgeom(This,buffer,geom)

#define ILibrary2_aprigeom(This,buffer,geom)	\
    (This)->lpVtbl -> aprigeom(This,buffer,geom)

#define ILibrary2_type_enum(This,idx,name,valid)	\
    (This)->lpVtbl -> type_enum(This,idx,name,valid)

#define ILibrary2_comp_enum(This,idx,name,valid)	\
    (This)->lpVtbl -> comp_enum(This,idx,name,valid)

#define ILibrary2_get_reporter(This,pVal)	\
    (This)->lpVtbl -> get_reporter(This,pVal)

#define ILibrary2_put_reporter(This,newVal)	\
    (This)->lpVtbl -> put_reporter(This,newVal)


#define ILibrary2_diag_open(This,filename,reporter,driver,compress,ppDisk)	\
    (This)->lpVtbl -> diag_open(This,filename,reporter,driver,compress,ppDisk)
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ILibrary2_diag_open_Proxy( 
    ILibrary2 __RPC_FAR * This,
    /* [in] */ BSTR filename,
    /* [in] */ IDispatch __RPC_FAR *reporter,
    /* [optional][in] */ BSTR driver,
...
void __RPC_STUB ILibrary2_diag_open_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#endif 	/* __ILibrary2_INTERFACE_DEFINED__ */
