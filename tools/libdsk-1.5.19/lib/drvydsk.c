...
dsk_err_t ydsk_open(DSK_DRIVER *self, const char *filename, DSK_REPORTFUNC diagfunc)
{
 ...
 * and under UNIX, the entire directory is filled with zeroes. */
	...
	if (diagfunc)
	{
		diaghead(diagfunc, "YAZE disk image");
		diaghex(diagfunc, 0, ydsk_self->ydsk_header, 16,
			"Magic number");
		diaghex(diagfunc, 0x10, ydsk_self->ydsk_header + 0x10, 1,
			"Version");
		diaghex(diagfunc, 0x11, ydsk_self->ydsk_header + 0x11, 0x0F,
			"Unused");
		diaghex(diagfunc, 0x20, ydsk_self->ydsk_header + 0x20, 2,
			"DPB: Records / track");
		diaghex(diagfunc, 0x22, ydsk_self->ydsk_header + 0x22, 1,
			"DPB: Block shift");
		diaghex(diagfunc, 0x23, ydsk_self->ydsk_header + 0x23, 1,
			"DPB: Block mask");
		diaghex(diagfunc, 0x24, ydsk_self->ydsk_header + 0x24, 1,
			"DPB: Extent mask");
		diaghex(diagfunc, 0x25, ydsk_self->ydsk_header + 0x25, 2,
			"DPB: Block count -1");
		diaghex(diagfunc, 0x27, ydsk_self->ydsk_header + 0x27, 2,
			"DPB: Directory entry count -1");
		diaghex(diagfunc, 0x29, ydsk_self->ydsk_header + 0x29, 2,
			"DPB: Directory bitmap");
		diaghex(diagfunc, 0x2B, ydsk_self->ydsk_header + 0x2B, 2,
			"DPB: Checksum size");
		diaghex(diagfunc, 0x2D, ydsk_self->ydsk_header + 0x2D, 2,
			"DPB: Reserved tracks");
		diaghex(diagfunc, 0x2F, ydsk_self->ydsk_header + 0x2F, 1,
			"DPB: Physical sector shift");
		diaghex(diagfunc, 0x30, ydsk_self->ydsk_header + 0x30, 1,
			"DPB: Physical sector mask");

		diaghex(diagfunc, 0x31, ydsk_self->ydsk_header + 0x31, 0x4F,
			"Unused");
		diagrawrange(diagfunc, ydsk_self->ydsk_fp, 0x80, -1, "CP/M filesystem");
	}
